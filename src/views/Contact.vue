      ...
      <div class="container mx-auto">
        <div class="text-center mb-12" data-aos="fade-up">
          ...
          <p class="text-lg max-w-3xl mx-auto">
            ...
            or just want to connect. I'm currently open to new opportunities!
          </p>
      ...
      <div class="container mx-auto">
        <div class="grid md:grid-cols-2 gap-12 items-start">
          ...
          <div class="contact-info" data-aos="fade-right">
            ...
            <p class="mb-8">
              I'm based in Ottawa, Canada and available for remote work or local opportunities.
            ...
            <div class="space-y-6">
              <div class="contact-item">
                ...
                <div class="contact-details">
                  <h3>Email</h3>
                  <a href="mailto:abdulmuiz.olatunbosun@gmail.com" class="text-primary hover:underline">abdulmuiz.olatunbosun@gmail.com</a>
                </div>
              </div>
              ...
              <div class="contact-item">
                ...
                <div class="contact-details">
                  <h3>LinkedIn</h3>
                  <a href="https://www.linkedin.com/in/abdul-muiz-olaleye/" target="_blank" class="text-primary hover:underline">abdul-muiz-olaleye</a>
                </div>
              </div>
              ...
              <div class="contact-item">
                ...
                <div class="contact-details">
                  <h3>GitHub</h3>
                  <a href="https://github.com/muheeeeez" target="_blank" class="text-primary hover:underline">muheeeeez</a>
                </div>
              </div>
              ...
              <div class="contact-item">
                ...
                <div class="contact-details">
                  <h3>Phone</h3>
                  <a href="tel:+17538861887" class="text-primary hover:underline">+1 (753) 886-1887</a>
                </div>
              </div>
            </div>
            ...
            <div class="mt-10">
              ...
              <div class="flex space-x-4">
                <a href="https://github.com/muheeeeez" target="_blank" class="social-icon">
                  <img src="../img/github-icon.png" alt="GitHub" />
                </a>
                <a href="https://www.linkedin.com/in/abdul-muiz-olaleye/" target="_blank" class="social-icon">
                  <img src="../img/linkedin-icon.png" alt="LinkedIn" />
                </a>
                <a href="https://twitter.com/IAmMuizOlaleye" target="_blank" class="social-icon">
          ...
          <div class="contact-form card" data-aos="fade-left">
            ...
            <form @submit.prevent="sendEmail">
              ...
              <div class="form-group">
                ...
                />
                <p v-if="formErrors.subject" class="error-text">{{ formErrors.subject }}</p>
              </div>
